...
import { getCategory, patchUpdateBook, postUploadBookImg } from '../../../services/apiServices';
...
const ModalUpdateBook = (props) => {
  ...
  const onFinish = async (values) => {
    ...
    setIsSubmit(true)
    const res = await patchUpdateBook(id, thumbnail, slider, mainText, author, price, sold, quantity, category);
    if (res && res.data) {
